#!/bin/bash
set -uo pipefail
# Standalone: schreibt a3refaat mimo_chat_template.jinja (bounded reasoning) in den upstream-Container.
# Extrahiert aus fix-mimo-v2-vllm/run.sh (670-834), da fix-mimo-v2-upstream es weglaesst.
